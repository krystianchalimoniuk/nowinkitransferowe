    ...
    class Schema1to2 : AutoMigrationSpec {
        override fun onPostMigrate(db: SupportSQLiteDatabase) {
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '3' AND '357' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '358' AND '811' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '812' AND '1531' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '1532' AND '2090' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '2091' AND '3747' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '3748' AND '4299' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '4300' AND '5870' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '5872' AND '6639' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '6640' AND '8269' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '8270' AND '8410' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '8411' AND '10938' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '10939' AND '11843' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '11844' AND '13939' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '13940' AND '14856' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
            ...
            db.execSQL(
                ...
                WHERE id BETWEEN '14857' AND '16931' AND (timestamp IS NULL OR season IS NULL)
                """,
            )
        }
    }
