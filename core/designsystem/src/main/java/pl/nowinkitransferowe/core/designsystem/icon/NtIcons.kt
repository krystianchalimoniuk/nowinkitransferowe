...
package pl.nowinkitransferowe.core.designsystem.icon
...
/**
 * Nowinki transferowe icons. Material icons are [ImageVector]s, custom icons are drawable resource IDs.
 */
object NtIcons {
    val Add = Icons.Rounded.Add
    val ArrowBack = Icons.AutoMirrored.Rounded.ArrowBack
    val Arrows = Icons.Rounded.SyncAlt
    val ArrowsBorder = Icons.Outlined.SyncAlt
