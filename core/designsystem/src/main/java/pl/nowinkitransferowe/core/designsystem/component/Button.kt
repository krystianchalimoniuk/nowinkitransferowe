...
fun NtButtonPreview() {
    NtTheme {
        NtBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            NtButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun NtOutlinedButtonPreview() {
    NtTheme {
        NtBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            NtOutlinedButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
